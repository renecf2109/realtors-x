...
export default async function PropertyPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const galleryMedia = featuredItems.filter(item => item.placement === "gallery" || (item.placement === "listing_featured" && (!item.link_url || item.link_url === listingPath || item.link_url.endsWith(listingPath))));
