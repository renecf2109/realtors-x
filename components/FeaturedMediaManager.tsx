...
import { featuredMediaPlacements, featuredMediaVisibility, validateFeaturedMedia } from "@/lib/featuredMedia";
...
function visibilityLabel(value: ReturnType<typeof featuredMediaVisibility>) { return value === "live" ? "Live" : value === "scheduled" ? "Scheduled" : value === "expired" ? "Expired" : "Inactive"; }
